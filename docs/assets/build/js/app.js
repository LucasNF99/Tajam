...
var spy = new gumshoejs__WEBPACK_IMPORTED_MODULE_1___default.a('#my-awesome-nav a');
var playBtn = document.querySelector(".play-pouse-btn");
var menuBtn = document.querySelector(".c-btn-menu");
var btnHamburger = document.querySelector(".o-btn-hamburguer");
var menu = document.querySelector(".c-menu");
var topBar = document.querySelector(".c-header_top-bar");
var menuItens = document.querySelector('.c-menu_list').querySelectorAll('.c-menu_list-item');
...
function scroll() {
  if (window.pageYOffset >= 20) topBar.classList.add("top-bc");else topBar.classList.remove("top-bc");
}

menuItens.forEach(function (elm) {
...
var video = document.querySelector('.c-wt-our-story_vd');
...
/***/ 0:
/*!************************************************************************!*\
  !*** multi ./source/_assets/js/app.js ./source/_assets/scss/main.scss ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/programacao/Documentos/projects/tajam/source/_assets/js/app.js */"./source/_assets/js/app.js");
module.exports = __webpack_require__(/*! /home/programacao/Documentos/projects/tajam/source/_assets/scss/main.scss */"./source/_assets/scss/main.scss");
